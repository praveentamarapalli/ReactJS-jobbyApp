...
class JobItemDetails extends Component {
  ...
  getFormattedSimilarJobsDetails = data => ({
    companyLogoUrl: data.company_logo_url,
    employmentType: data.employment_type,
    id: data.id,
    jobDescription: data.job_description,
  ...
  getFormattedSkillsDetails = data => ({
  ...
  getJobDetails = async () => {
    ...
    if (response.ok) {
      ...
      console.log(data)
      const updatedJobDetails = this.getFormattedJobsDetails(data.job_details)
      const updatedSimilarJobsDetails = data.similar_jobs.map(eachItem =>
        this.getFormattedSimilarJobsDetails(eachItem),
      )
      const updatedSkillsList = data.job_details.skills.map(eachItem =>
        this.getFormattedSkillsDetails(eachItem),
      )
      this.setState({
        apiStatus: apiStatusConstants.success,
        jobDetails: updatedJobDetails,
        similarJobsDetails: updatedSimilarJobsDetails,
  ...
  renderJobDetailsView = () => {
    const {jobDetails, skillsList, similarJobsDetails} = this.state
      ...
      <div className="job-details-view-container">
            ...
            <div className="location-package-container">
              <div className="location-employee-container">
                ...
                <div className="employee-type-container">
                  ...
                  <p className="brief-case-icon">{employmentType}</p>
                </div>
              </div>
        ...
        <ul className="similar-jobs-list">
          {similarJobsDetails.map(eachItem => (
            <SimilarJobItem jobsDetails={eachItem} key={eachItem.id} />
          ))}
        </ul>
      </div>
    )
